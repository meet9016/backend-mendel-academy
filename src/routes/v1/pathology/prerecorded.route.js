...
router.post('/create', upload.single("image"), validate(preRecordedController.createPreRecorded.validation), catchAsync(preRecordedController.createPreRecorded.handler));
...
router.put('/update/:_id', upload.single("image"), validate(preRecordedController.updatePreRecorded.validation), catchAsync(preRecordedController.updatePreRecorded.handler));
