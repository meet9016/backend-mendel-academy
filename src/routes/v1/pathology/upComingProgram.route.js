...
router.post('/create', validate(upCommingProgramController.createUpcomingProgram.validation), catchAsync(upCommingProgramController.createUpcomingProgram.handler));
...
router.put('/update/:_id', validate(upCommingProgramController.updateUpComingProgram.validation), catchAsync(upCommingProgramController.updateUpComingProgram.handler));
